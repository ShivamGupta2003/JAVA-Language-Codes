...
// SOLUTION CLASS THAT CONTAINS FUNCTION TO SOLVE PROBELM
public class Solution {
        ...
        public static BinaryTreeNode<Integer> SortedArrayToBST(int[] arr, int si,int ei)
        {
            ...
            BinaryTreeNode<Integer> ans=new BinaryTreeNode<Integer>(arr[l]);
            ans.left=SortedArrayToBST(arr,si,l-1);
            ans.right=SortedArrayToBST(arr,l+1,ei);
